        ...
        />
			...
			<div className="col-12 col-md-12">
				...
				<div className="row trip-info1 summary">
					...
					<div className="col-12 mb-2"><i className = "mr-2 fa fa-inr"/>15,000/person for a single booking </div>
					<div className="col-12 mb-2"><i className = "mr-2 fa fa-inr"/>13,000/person for a group of 2-3 </div>
...
<a href="https://www.instamojo.com/10journeys/a-creative-journey-amidst-the-himalayas-7f822/" rel="im-checkout" data-behaviour="remote" data-style="flat" data-text="Book Now"></a>
		      ...
		      <Card>
		        <CardBody>
		          ...
		          <CardSubtitle className="mb-3">13000/person</CardSubtitle>
