     ...
     <div className="col-12">
        ...
        <Collapse isOpen={this.state.collapse1}>
          <div className = "answer">
            The journey begins at McLeodGanj at 9am, where you can reach by road or by air (Ghaggal Airport).
            Many buses are available from Delhi, Chandigarh and other cities.
            Don't worry if you reach a few hours early. Once you reach McLeodGanj, we will have a comfortable place for you to rest and
      ...
      <div className="col-12">
        ...
        <Collapse isOpen={this.state.collapse3}>
          <div className = "answer">
         This is a small group journey with maximum 10 people. A small group helps in a more 
